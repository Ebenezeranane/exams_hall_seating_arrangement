                ...
                <div class="col-md-10">
                  <div class="card shadow-sm">
                    <div class="card-header text-dark">
                      <strong>ADD INVIGILATOR</strong>
                      <span class="pull-right"><i class="fas fa-eye fa-2x icon-color"></i></span>
                    </div>
                    <div class="card-body">
                      <div class="form-group">
                        {!! Form::open(['method'=>'POST','action'=>'InvigilatorController@store','enctype'=>'multipart/form-data']) !!}
                        ...
                        Invigilator Name
                           {!! Form::text('Invigilator_name','', ['class'=>'form-control','placeholder'=>'Invigilator Name','required'=>'required']) !!} <br>
           
           
                        E mail Address 
                           {!! Form::text('e_mail','', ['class'=>'form-control','placeholder'=>'E mail Address','required'=>'required']) !!} <br>
               
                    
                        Phone Number
                           {!! Form::text('phone','', ['class'=>'form-control','placeholder'=>'Phone Number','required'=>'required']) !!} <br>
               
                    
                    
                        Department  
                           {!! Form::text('department','', ['class'=>'form-control','placeholder'=>'enter Department ','required'=>'required']) !!} <br>

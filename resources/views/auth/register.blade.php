                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="programme" type="text"
                                           class="form-control @error('programme') is-invalid @enderror" name="programme"
                                           value="{{ old('programme') }}" required autocomplete="programme" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="index" type="number"
                                           ...
                                           value="{{ old('index') }}" required autocomplete="index" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="studentID" type="number"
                                           ...
                                           value="{{ old('studentID') }}" required autocomplete="studentID" autofocus>

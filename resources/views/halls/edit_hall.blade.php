                ...
                <div class="col-md-10">
                  <div class="card shadow-sm">
                    <div class="card-header text-dark">
                      <strong>EDIT EXAM HALL</strong>
                      <span class="pull-right"><i class="fas fa-school fa-2x icon-color"></i></span>
                    </div>
                    <div class="card-body">
                      <div class="form-group">
                        {!! Form::open(['action'=>['ExamsHallController@update',$halls->id],'method'=>'POST']) !!}   
                        ...
                        Hall Name
                           {!! Form::text('hall_name',$halls->hall_name, ['class'=>'form-control','placeholder'=>'Hall Name','required'=>'required']) !!} <br>
           
           
                        Location 
                           {!! Form::text('location',$halls->location, ['class'=>'form-control','placeholder'=>'location','required'=>'required']) !!} <br>
              
                           Rows
                           {!! Form::number('rows',$halls->rows, ['class'=>'form-control','placeholder'=>'enter number of rows','required'=>'required']) !!} <br>
                  
                    
                          Columns
                           {!! Form::number('columns',$halls->columns, ['class'=>'form-control','placeholder'=>'enter number of columns','required'=>'required']) !!} <br>
                  
                   {!! Form::hidden('_method', 'PUT') !!} 
                  {!! Form::submit('sumbit', ['class'=>'btn btn-primary mt-3 ']) !!} 

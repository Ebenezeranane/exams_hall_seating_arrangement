            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="card shadow-sm">
                  <div class="card-header text-dark"> <strong>ALL COURSES</strong>
                    <a href="/admin/course/create" class="btn  btn-sm pull-right icon-color"><i class="fas fa-plus-circle fa-2x"></i></a>
                  </div>
                  <div class="card-body">
                    @if(count($courses)>0)
                    <table class="table table-striped table-responsive-sm table-responsive-md">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="/admin/course/{{ $course->id }}/edit"><i class="fas fa-pen"></i></a>
                    ...
                    @else
                    <h3><strong>There are no Courses registered </strong></h3>
                    @endif

                  ...
                  <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        Course Name
                           {!! Form::text('course_name',$courses->course_name, ['class'=>'form-control','required'=>'required']) !!} <br>
           
           
                        Course Code 
                           {!! Form::text('course_code',$courses->course_code, ['class'=>'form-control','required'=>'required']) !!} <br>
               
                    
                     
                    
                        Number of Students 
                           {!! Form::number('no_of_students',$courses->no_of_students, ['class'=>'form-control','required'=>'required']) !!} <br>
                  
                     {!! Form::hidden('_method', 'PUT') !!} 
                  {!! Form::submit('SUBMIT', ['class'=>'btn btn-primary mt-3 ','required'=>'required']) !!} 

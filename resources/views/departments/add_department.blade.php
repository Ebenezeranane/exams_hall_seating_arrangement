                  ...
                  <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        Department Name
                           {!! Form::text('department_name','', ['class'=>'form-control','placeholder'=>'department Name','required'=>'required']) !!} <br>
           
           
                        Department Code 
                           {!! Form::text('department_code','', ['class'=>'form-control','placeholder'=>'department Code','required'=>'required']) !!} <br>
               
                    
                        Department Head
                           {!! Form::text('department_head','', ['class'=>'form-control','placeholder'=>'department head','required'=>'required']) !!} <br>

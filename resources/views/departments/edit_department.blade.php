                ...
                <div class="col-md-10">
                  <div class="card shadow-sm">
                    <div class="card-header text-dark">
                      <strong>EDIT A DEPARTMENT</strong>
                      <span class="pull-right"><i class="far fa-building fa-2x icon-color"></i></span>
                    </div>
                    <div class="card-body">
                      <div class="form-group">
                        {!! Form::open(['action'=>['DepartmentController@update',$departments->id],'method'=>'POST']) !!}   
                        ...
                        Department Name
                           {!! Form::text('department_name',$departments->department_name, ['class'=>'form-control','required'=>'required']) !!} <br>
           
           
                        Department Code 
                           {!! Form::text('department_code',$departments->department_code, ['class'=>'form-control','required'=>'required']) !!} <br>
               
                    
                        Department Head
                           {!! Form::text('department_head',$departments->department_head, ['class'=>'form-control','required'=>'required']) !!} <br>
               
                    
                    
                        Number of Students 
                           {!! Form::number('no_of_students',$departments->no_of_students, ['class'=>'form-control','required'=>'required']) !!} <br>
